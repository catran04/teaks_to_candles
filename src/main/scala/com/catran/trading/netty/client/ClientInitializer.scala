...
/**
  ...
  */
class ClientInitializer(options: ApplicationOptions, channelHandler: ChannelHandler) extends ChannelInitializer[SocketChannel]{
...
//    pipeline.addLast("encoder", new StringEncoder())
    pipeline.addLast("handler", new TeakHandlerJava(new SQLiteTeakDao(options, new SQLiteConnector())))
  }
}
